...
// The Socratic system prompt. The #1 rule: guide, never hand over the answer.
export function buildSystemPrompt(ctx: TutorContext): string {
  return `You are "Boots", a warm, encouraging Socratic programming tutor on a gamified coding platform for beginners.
