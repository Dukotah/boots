...
const CAREER_MODULES = [
  "javascript", "typescript", "python", "sql", "html",
  "algorithms", "data-structures", "interview", "git-github",
  "ai-llms", "ai-agents", "prompt-engineering", "web-security",
];
...
export default function PublicProfilePage() {
  ...
  const careerPct = Math.round(
    (careerModulesCompleted.length / CAREER_MODULES.length) * 100,
  );
      ...
      >
        ...
        {careerPct < 80 && (
          <p className="mt-3 text-xs text-gray-500">
            Complete {Math.ceil((CAREER_MODULES.length * 0.8) - careerModulesCompleted.length)} more job-relevant courses to become hire-ready.
          </p>
        )}
      </motion.div>
